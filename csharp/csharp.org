...
- [[#resources][Resources]]
- [[#speaking-c][Speaking C#]]
  - [[#discover-c-compiler-version][Discover C# Compiler Version]]
    - [[#choose-a-specific-language-version][Choose a Specific Language Version]]
  - [[#c-basics][C# Basics]]
    - [[#comments][Comments]]
    - [[#blocks][Blocks]]
    - [[#methods][Methods]]
    - [[#types][Types]]
    - [[#comparing-double--decimal-types][Comparing Double & Decimal Types]]
  - [[#controlling-flow-and-converting-types][Controlling Flow and Converting Types]]
    - [[#note-on-foreach][Note on ~foreach~]]
    - [[#casting-and-converting][Casting and Converting]]
    - [[#parase-tryparase-and-convert][~Parase~, ~TryParase~ and ~Convert~]]
    - [[#handling-exceptions][Handling Exceptions]]
  - [[#array-syntax][Array Syntax]]
  - [[#lambada][Lambada]]
- [[#building-oop][Building O.O.P]]
  - [[#referencing-an-assembly][Referencing an Assembly]]
  - [[#access-modifiers][Access Modifiers]]
  - [[#static-field][Static Field]]
  - [[#constant-read-only-and-event][Constant, Read-only, and Event]]
  - [[#tuples-to-return-more-than-one-value][Tuples to Return More Than One Value]]
  ...
  - [[#implementing-interfaces][Implementing Interfaces]]
    ...
    - [[#icloneable-you-dont-want-to-implement-this-and-copying-methods][~ICloneable~ /You don't want to implement this!/ and Copying Methods]]
    - [[#iequalitycomparer][~IEqualityComparer~]]
  - [[#interfaces-a-point][Interfaces: A point]]
  - [[#delegates][Delegates]]
    - [[#anonymous-delegate][Anonymous Delegate]]
  - [[#events][Events]]
  - [[#attributes][Attributes]]
    - [[#conditional-attribute][Conditional Attribute]]
    - [[#obselete-attribute][Obselete Attribute]]
    - [[#creating-custom-attribute][Creating Custom Attribute]]
- [[#common-types][Common Types]]
  ...
  - [[#collections][Collections]]
    - [[#listt][~List<T>~]]
    - [[#dictionaryt_key-t_value][~Dictionary<T_Key, T_Value>~]]
    - [[#stack][~Stack~]]
    - [[#queue][~Queue~]]
    - [[#linkedlistt][~LinkedList<T>~]]
    - [[#hashset-sortedset][~HashSet~, ~SortedSet~]]
    - [[#concurrentqueuet][~ConcurrentQueue<T>~]]
    - [[#concurrentqueuet-1][~ConcurrentQueue<T>~]]
    - [[#concurrentstackt][~ConcurrentStack<T>~]]
    - [[#concurrentdictionarytkeytvalue][~ConcurrentDictionary<TKey,TValue>~]]
- [[#assemblies-namespaces-packages-and-frameworks][Assemblies, Namespaces, Packages, and Frameworks]]
- [[#difference-between-net-framework-and-net-core][Difference between .NET Framework and .NET Core]]
- [[#publishing][Publishing]]
  - [[#framework-dependent-deployment-fdd][Framework-dependent deployment (FDD).]]
  - [[#framework-dependent-executables-fdes][Framework-dependent executables (FDEs).]]
    - [[#advantages][Advantages]]
    - [[#disadvantages][Disadvantages]]
  - [[#self-contained][Self-contained.]]
    - [[#advantages-1][Advantages]]
    - [[#disadvantages-1][Disadvantages]]
- [[#misc-notes][/Misc Notes/]]
  - [[#operators][Operators]]
    - [[#null-conditional-operators--and-][Null-conditional operators ~??~ and ~??=~]]
    - [[#null-conditional-operators--and--1][Null-conditional Operators ~?.~ and ~?[]~]]
    - [[#range-operator-][Range Operator ~..~]]
  - [[#static-class][Static class]]
  - [[#constants][Constants?]]
  - [[#get-set][~{get; set}~]]
  - [[#partial-class][~partial class~]]
  - [[#use-class-use-struct][Use ~class~, Use ~struct~]]
  - [[#mutable-vs-immutable][Mutable vs. Immutable]]
    - [[#string-1][~String~]]
    - [[#stringbuilder][~StringBuilder~]]
    - [[#creating-an-immutable-class][Creating an Immutable Class]]
  - [[#uses-of-using][Uses of Using]]
  - [[#boxing-and-unboxing][Boxing and Unboxing]]
- [[#linq][LINQ]]
- [[#take-a-look][Take a Look]]
- [[#todos][TODOs]]
  - [[#implement-idisposable][Implement ~IDisposable~]]
  - [[#gethash][GetHash]]
